...
/* Punto ana sayfayla aynı: aynı logo iki sayfada iki boyda durmayacak. */
.mark{font-family:"Million Astteroids","New York",ui-serif,Georgia,serif;font-size:42px;line-height:1;padding-top:6px}
@media(max-width:760px){.mark{font-size:34px;padding-top:4px}}
