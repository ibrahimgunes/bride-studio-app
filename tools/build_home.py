...
"Upload one photo and see yourself wearing the wedding dress — your face, your skin tone, your figure. Over 150 gowns to try on from your sofa.": {
 "tr":"Tek bir fotoğraf yükle, gelinliği üzerinde gör — kendi yüzün, kendi teninin rengi, kendi bedenin. Koltuğundan denenecek 150'den fazla gelinlik.",
 "de":"Lade ein Foto hoch und sieh dich im Brautkleid — dein Gesicht, dein Hautton, deine Figur. Über 150 Kleider, vom Sofa aus anprobiert.",
 "es":"Sube una foto y mírate con el vestido de novia — tu cara, tu tono de piel, tu figura. Más de 150 vestidos para probarte desde el sofá.",
 "fr":"Envoyez une photo et voyez-vous en robe de mariée — votre visage, votre teint, votre silhouette. Plus de 150 robes à essayer depuis votre canapé.",
 "it":"Carica una foto e guardati nell'abito da sposa — il tuo viso, il tuo incarnato, la tua figura. Oltre 150 abiti da provare dal divano.",
 "pt-BR":"Envie uma foto e veja-se no vestido de noiva — seu rosto, seu tom de pele, seu corpo. Mais de 150 vestidos para experimentar do sofá.",
 "ja":"写真を1枚アップロードするだけで、ウェディングドレス姿の自分が見られます。あなたの顔、あなたの肌、あなたの体で。150着以上をソファから試着。",
 "ko":"사진 한 장이면 웨딩드레스를 입은 내 모습을 볼 수 있습니다. 내 얼굴, 내 피부톤, 내 체형 그대로. 150벌 넘는 드레스를 소파에서.",
 "zh-Hans":"上传一张照片，看见穿上婚纱的自己——你的脸、你的肤色、你的身形。150 多款婚纱，在沙发上试穿。",
 "hi":"एक फ़ोटो अपलोड करें और खुद को वेडिंग ड्रेस में देखें — आपका चेहरा, आपकी रंगत, आपकी काया। सोफ़े से ही 150 से ज़्यादा गाउन आज़माएँ।"},
...
"Over 150 gowns,<br>and every one described.": {
 "tr":"150'den fazla gelinlik,<br>ve her biri anlatılmış.",
 "de":"Über 150 Kleider,<br>und jedes beschrieben.",
 "es":"Más de 150 vestidos,<br>y cada uno descrito.",
 "fr":"Plus de 150 robes,<br>et chacune décrite.",
 "it":"Oltre 150 abiti,<br>e ognuno descritto.",
 "pt-BR":"Mais de 150 vestidos,<br>e cada um descrito.",
 "ja":"150着以上、<br>そのすべてに説明を。",
 "ko":"150벌이 넘는 드레스,<br>하나하나 설명과 함께.",
 "zh-Hans":"150 多款婚纱，<br>每一件都有说明。",
 "hi":"150 से ज़्यादा गाउन,<br>और हर एक का ब्योरा।"},
"Browse all 151 gowns": {"tr":"151 gelinliğin tamamı","de":"Alle 151 Kleider ansehen","es":"Ver los 151 vestidos",
 "fr":"Voir les 151 robes","it":"Vedi tutti i 151 abiti","pt-BR":"Ver os 151 vestidos",
 "ja":"151着すべてを見る","ko":"151벌 모두 보기","zh-Hans":"浏览全部 151 款","hi":"सभी 151 गाउन देखें"},
