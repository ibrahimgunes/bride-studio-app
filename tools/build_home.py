...
"Upload one photo and see yourself wearing the wedding dress — your face, your skin tone, your figure. Over 290 gowns to try on from your sofa.": {
 "tr":"Tek bir fotoğraf yükle, gelinliği üzerinde gör — kendi yüzün, kendi teninin rengi, kendi bedenin. Koltuğundan denenecek 290'den fazla gelinlik.",
 "de":"Lade ein Foto hoch und sieh dich im Brautkleid — dein Gesicht, dein Hautton, deine Figur. Über 290 Kleider, vom Sofa aus anprobiert.",
 "es":"Sube una foto y mírate con el vestido de novia — tu cara, tu tono de piel, tu figura. Más de 290 vestidos para probarte desde el sofá.",
 "fr":"Envoyez une photo et voyez-vous en robe de mariée — votre visage, votre teint, votre silhouette. Plus de 290 robes à essayer depuis votre canapé.",
 "it":"Carica una foto e guardati nell'abito da sposa — il tuo viso, il tuo incarnato, la tua figura. Oltre 290 abiti da provare dal divano.",
 "pt-BR":"Envie uma foto e veja-se no vestido de noiva — seu rosto, seu tom de pele, seu corpo. Mais de 290 vestidos para experimentar do sofá.",
 "ja":"写真を1枚アップロードするだけで、ウェディングドレス姿の自分が見られます。あなたの顔、あなたの肌、あなたの体で。290着以上をソファから試着。",
 "ko":"사진 한 장이면 웨딩드레스를 입은 내 모습을 볼 수 있습니다. 내 얼굴, 내 피부톤, 내 체형 그대로. 290벌 넘는 드레스를 소파에서.",
 "zh-Hans":"上传一张照片，看见穿上婚纱的自己——你的脸、你的肤色、你的身形。290 多款婚纱，在沙发上试穿。",
 "hi":"एक फ़ोटो अपलोड करें और खुद को वेडिंग ड्रेस में देखें — आपका चेहरा, आपकी रंगत, आपकी काया। सोफ़े से ही 290 से ज़्यादा गाउन आज़माएँ।"},
...
"Over 290 gowns,<br>and every one described.": {
 "tr":"290'den fazla gelinlik,<br>ve her biri anlatılmış.",
 "de":"Über 290 Kleider,<br>und jedes beschrieben.",
 "es":"Más de 290 vestidos,<br>y cada uno descrito.",
 "fr":"Plus de 290 robes,<br>et chacune décrite.",
 "it":"Oltre 290 abiti,<br>e ognuno descritto.",
 "pt-BR":"Mais de 290 vestidos,<br>e cada um descrito.",
 "ja":"290着以上、<br>そのすべてに説明を。",
 "ko":"290벌이 넘는 드레스,<br>하나하나 설명과 함께.",
 "zh-Hans":"290 多款婚纱，<br>每一件都有说明。",
 "hi":"290 से ज़्यादा गाउन,<br>और हर एक का ब्योरा।"},
